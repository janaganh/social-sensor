...
import com.dalsps.net.XmppManager;
...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        Helper.startSvcIntent(context, MainService.ACTION_BROADCAST_STATUS);
    ...
    public void doUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds, int state) {
        ...
        switch (state) {
            case XmppManager.CONNECTED:
                views.setImageViewResource(R.id.Button, R.drawable.ic_green);
                break;
            case XmppManager.DISCONNECTED:
                views.setImageViewResource(R.id.Button, R.drawable.ic_red);
                break;
            case XmppManager.DISCONNECTING:
            case XmppManager.WAITING_TO_CONNECT:
            case XmppManager.CONNECTING:
            case XmppManager.WAITING_FOR_NETWORK:
                views.setImageViewResource(R.id.Button, R.drawable.ic_orange);
                break;
            default:
                break;
         }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (action.equals(MainService.ACTION_WIDGET_ACTION)) {
            //Helper.startSvcIntent(context, MainService.ACTION_TOGGLE);
