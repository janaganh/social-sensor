...
public class UpdaterService extends IntentService {
	...
	private void newStatusNotification(int count) {
		...
		Intent broadcast = new Intent(DalspsApplication.ACTION_NEW_STATUS);
		broadcast.putExtra(DalspsApplication.EXTRA_NEW_STATUS_COUNT, count);
		sendBroadcast(broadcast, DalspsApplication.RECEIVE_NEW_STATUS);
		...
		PendingIntent showMessagesPendingIntent
			= PendingIntent.getActivity(this, DalspsApplication.SHOW_NEW_STATUS_PENDING_INTENT,
		...
		nm.notify(DalspsApplication.NEW_STATUS_NOTIFICATION, notification);
	}
